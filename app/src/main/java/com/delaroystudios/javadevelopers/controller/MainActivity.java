...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeContainer.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener(){
            ...
            public void onRefresh(){
                loadJSON();
                Toast.makeText(MainActivity.this, "WHOOOSH!!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void initViews(){
        ...
        pd.setMessage("Buscando usuarios de Santo Domingo en Github...");
        ...
        try{
            ...
            call.enqueue(new Callback<ItemResponse>() {
                ...
                public void onFailure(Call<ItemResponse> call, Throwable t) {
                    ...
                    Toast.makeText(MainActivity.this, "Error mangando la data :(", Toast.LENGTH_SHORT).show();
